...
/* Close how-we-rate tooltip on outside click */
document.addEventListener('click', function(e) {
  document.querySelectorAll('.how-we-rate-tooltip.active').forEach(function(t) {
    if (!t.contains(e.target)) t.classList.remove('active');
  });
});
